...
<header class="navbar bg-white position-fixed flex-nowrap top-0 w-100 p-0 border-bottom border-green-100">
	<a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="/douzone/workspace"><img src="${pageContext.request.contextPath}/resources/static/image/icon/logo.png" alt="logo"  style="width: 40px; height: 40px; display: inline;"></a>
